    ...
    public class ContextModelSnapshot : ModelSnapshot
    {
        ...
        public class Context : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptions builder)
            {
                builder
                    .UseModel(_model)
                    .AddBuildAction(c => c.AddOrUpdateExtension<MyRelationalConfigurationExtension>(x => x.ConnectionString = "ConnectionString"))
                    .AddBuildAction(c => c.AddOrUpdateExtension<MyRelationalConfigurationExtension>(x => x.MigrationNamespace = "MyNamespace"));
            }
        }
